package edu.aku.covid_followup_app.activities.menu;
...
public class MenuActivity extends AppCompatActivity {
    ...
    /*public void dbBackup() {
        ...
        if (sharedPref.getBoolean("checkingFlag", false)) {
            ...
            String dt = sharedPref.getString("dt", new SimpleDateFormat("dd-MM-yyyy", Locale.getDefault()).format(new Date()));

            if (!dt.equals(new SimpleDateFormat("dd-MM-yyyy", Locale.getDefault()).format(new Date()))) {
                editor.putString("dt", new SimpleDateFormat("dd-MM-yyyy", Locale.getDefault()).format(new Date()));
