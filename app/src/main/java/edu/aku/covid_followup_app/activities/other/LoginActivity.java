...
import edu.aku.covid_followup_app.activities.sync.SyncActivity;
...
import static edu.aku.covid_followup_app.CONSTANTS.MINIMUM_DISTANCE_CHANGE_FOR_UPDATES;
import static edu.aku.covid_followup_app.CONSTANTS.MINIMUM_TIME_BETWEEN_UPDATES;
import static edu.aku.covid_followup_app.CONSTANTS.MY_PERMISSIONS_REQUEST_READ_CONTACTS;
import static edu.aku.covid_followup_app.CONSTANTS.MY_PERMISSIONS_REQUEST_READ_PHONE_STATE;
import static edu.aku.covid_followup_app.CONSTANTS.TWO_MINUTES;
import static edu.aku.covid_followup_app.utils.OtherUtilsKt.dbBackup;
import static edu.aku.covid_followup_app.utils.OtherUtilsKt.getPermissionsList;
