...
public class PersonalContract {
    ...
    public PersonalContract sync(JSONObject jsonObject) throws JSONException {
        ...
        this.pa01 = jsonObject.getString(PersonalTable.COLUMN_PA01);
    ...
    public PersonalContract hydrate(Cursor cursor) {
        ...
        this.pa01 = cursor.getString(cursor.getColumnIndex(PersonalTable.COLUMN_PA01));
    ...
    public JSONObject toJSONObject() {
        ...
        try {
            ...
            json.put(PersonalTable.COLUMN_PA01, this.pa01 == null ? JSONObject.NULL : this.pa01);
    ...
    public static abstract class PersonalTable implements BaseColumns {
        public static final String TABLE_NAME = "personals_r4";
