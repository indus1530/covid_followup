...
const val SQL_CREATE_PERSONALS_TABLE = (("CREATE TABLE "
        ...
        + PersonalTable.COLUMN_FORMDATE + " TEXT,"
        + PersonalTable.COLUMN_SYSDATE + " TEXT,"
        + PersonalTable.COLUMN_APPVERSION + " TEXT,"
        + PersonalTable.COLUMN_CLUSTERCODE + " TEXT,"
        + PersonalTable.COLUMN_HHNO + " TEXT,"
        + PersonalTable.COLUMN_SA + " TEXT,"
        + PersonalTable.COLUMN_PA01 + " TEXT,"
        + PersonalTable.COLUMN_PA03 + " TEXT,"
