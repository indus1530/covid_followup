package edu.aku.smk_hhlisting_app.activities.sync;
...
import edu.aku.smk_hhlisting_app.adapters.SyncListAdapter;
import edu.aku.smk_hhlisting_app.adapters.UploadListAdapter;
import edu.aku.smk_hhlisting_app.contracts.FormsContract;
import edu.aku.smk_hhlisting_app.core.MainApp;
import edu.aku.smk_hhlisting_app.databinding.ActivitySyncBinding;
import edu.aku.smk_hhlisting_app.download.GetAllData;
import edu.aku.smk_hhlisting_app.other.SyncModel;
import edu.aku.smk_hhlisting_app.sync.SyncAllData;
import edu.aku.smk_hhlisting_app.sync.SyncDevice;
